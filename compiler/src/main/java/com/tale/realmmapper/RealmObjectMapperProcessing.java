...
public class RealmObjectMapperProcessing extends AbstractProcessing<RealmObjectSpec, State> {

  private final Set<RealmObjectExtractor> extractors;

  public RealmObjectMapperProcessing(Elements elements, Types types, Errors errors, State state) {
  ...
  @Override public AbstractComposer<RealmObjectSpec> createComposer() {
    return new RealmObjectMapperComposer(specs);
  }
